export const translations = {
  pt: {
    ...
    filters: {
      ...
      order: "Ordenação",
      options: "Opções",
      specialForms: "Formas especiais",
      specialFormsHelp: "Selecione as formas que deseja exibir no lugar dos Pokémon padrão.",
      formsSelected: "formas selecionadas",
  ...
  en: {
    ...
    filters: {
      ...
      specialFormsHelp: "Select the forms to display instead of the standard Pokémon.",
